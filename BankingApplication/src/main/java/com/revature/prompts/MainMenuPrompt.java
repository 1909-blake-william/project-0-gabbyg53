...
public class MainMenuPrompt implements Prompt {
	...
	@Override
	public Prompt run() {
		System.out.println("Welcome to Banking Application " + authUtil.getCurrentUser() );
		System.out.println(authUtil.getCurrentUser().getUsername() + " Please choose an option");
